...
from binance_signal_generator.config import load_config, SRLevelCalculatorConfig
...
class SRLevelCalculator:
    ...
    Attributes:
        config: S/R level configuration (loaded from config.yaml)
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.config = loaded_config.sr_levels
        self.wall_detector = WallDetector(config_path)
        self.max_pain_calc = MaxPainCalculator(config_path)
